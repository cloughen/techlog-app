    ...
    context '異常系' do
      context 'titleが空の場合' do
        ...
        it '無効である' do
          ...
          expect(post.errors[:title]).to include('タイトルが入力されていません。')
        end
      end
      ...
      context 'contentが空の場合' do
        ...
        it '無効である' do
          expect(post.valid?).to be(false)
          expect(post.errors[:content]).to include('本文が入力されていません。')
        end
      end
      ...
      context 'user_idが空の場合' do
        ...
        it '無効である' do
          expect(post.valid?).to be(false)
          expect(post.errors[:user]).to include("%{@user_id}が入力されていません。")
        end
      end
    end
  end
